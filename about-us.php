    ...
    <div class="content-page">
        ...
        <div class="about-salon">
            ...
            <div class="about-salon__description">
                <p>
                    Название нашего салона красоты выбрано не случайно – <b>Афродита</b> является символом
                    женственности,
                    красоты и
        ...
        <div class="about-salon">
            <div class="about-salon__description">
                <p>
                    ...
                    <br><br><b>Бактерицидная лампа:</b><br><p>
                <ul class='lamp'>
                    <li>очищает воздух
                    <li>уничтожает полевых клещей
                    <li>уничтожает вирусы
                    <li>уничтожает бактерии
                </ul>
<p><br><br>Лампа в салоне находится в закрытом виде, что <b>безопасно</b> для использования в присутствии
                людей.
                </p>
            </div>
            <div class='about-salon__image-container'>
        ...
        <div class="about-salon">
            ...
            <div class="about-salon">
                ...
                <div class="about-us__text">
                    ...
                    красоту и насладиться высоким качеством услуг. <br><br> <b>Мы рады видеть вас у нас и гарантируем
                    незабываемый опыт
                    преображения!</b>
                    <br>
                    <br>

...
<html lang="ru">
    ...
    flex-wrap: wrap;
            ...
            .lk a{
                color:rgb(var(--first-color-rgb));
            }
            .profile-btn{
               text-align:center;
               background-color:rgb(var(--second-color-rgb));
               padding:3%;
               margin:1%;
               display: block;
               font-size:0.9em;

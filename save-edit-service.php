...
//
    ...
    ;
    $query = "UPDATE services set service='" . $service_name . "', price=$price, category_id=$category_id,duration_in_min=$service_duration, is_recording=$service_recording where id=$service_id";
